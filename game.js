game.things = (function(){
  var items = {
    bat: {
      name: 'bat',
      effects: {
        'player_inventory': { message: "<p>You picked up the mouse!</p>",
                            object: "addItem",
                            subject: "deleteItem"
        },
        'dino': { message: "<p>You click and connect to the internet!</p><p>Now everyone's happy.</p>",
                  subject: 'deleteItem',
                  object: 'deleteItem',
        ...
        'empty': {
              message: "<p>You set the mouse down over there.</p>",
              object: "addItem",
              subject: "deleteItem"
        }
      }
    ...
    dino: {
      name: 'dino',
      effects: {
        'player_inventory': { message: "<p>You can't move the computer...</p>" } 
      }
    }
  };
